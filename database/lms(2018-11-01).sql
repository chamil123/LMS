...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 01, 2018 at 03:56 PM
...
(4, '003', 'Kahangama', 'Tuesday', 0, 2, 13),
(5, '002', 'Meegasvela', 'Tuesday', 0, 1, 17),
(6, '003', 'Atulugama', 'Wednesday', 0, 1, 18);
...
(6, 'Palihena', 'Nirmal', 'N', '763073428V', '1976-02-09', '+94716460880', '130/B', 'dandeniya', 'eheliyagoda', '', 0, 1),
(7, 'Kumarasingha', 'Nishantha', 'N', '793083428V', '1979-03-15', '+94719863540', '131/A', 'mahahenwatta', 'dandeniya', 'eheliyagoda', 0, 2),
(8, 'Sandakelum', 'Gihan', 'g', '803079869V', '1980-11-19', '+94716894650', '156/C', 'nungamuwa', 'dalugama', 'kelaniya', 0, 3);
...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  PRIMARY KEY (`member_id`,`center_id`,`group_id`),
  KEY `fk_Member_Center1_idx` (`center_id`),
  KEY `fk_member_member_group1_idx` (`group_id`)
...
INSERT INTO `member` (`member_id`, `member_number`, `member_NIC`, `member_surNmae`, `member_initialInFulWithoutSurname`, `member_inital`, `member_dateOfBirth`, `member_maritalStatus`, `member_gender`, `member_nationality`, `member_mobileNumber`, `member_homeNumber`, `member_branchNumber`, `member_status`, `member_AddressLine1`, `member_AddressLine2`, `member_AddressLine3`, `member_AddressLine4`, `member_code`, `center_id`, `group_id`) VALUES
(1, 'SR01/001/001', '883073829V', 'Pathirana', 'Chamil', 'C', '1988-02-24', 'Sigle', 'male', 'Sinhala', '+94716460440', '0362258590', '01', 'Active', '5/A', 'dalugama', 'kelaiya', '', '0000000001', 3, 5),
(2, 'SR01/001/002', '926086728V', 'Gunawardhana', 'Madushan', 'M', '1993-06-15', 'Married', 'male', 'Sinhala', '+94719860880', '0362258460', '01', 'Active', '5/A', 'Megahawatta', 'kiribathgoda', '', '0000000002', 3, 5),
(3, 'SR01/003/001', '943086489V', 'Kumarasigha', 'Sajith', 'S', '1994-07-21', 'Married', 'male', 'Sinhala', '+94716860990', '0365896400', '01', 'Active', '45/B', 'dandeniya', 'eheliyagoda', '', '0000000003', 3, 5);
...
--
ALTER TABLE `member`
  ADD CONSTRAINT `fk_member_member_group1` FOREIGN KEY (`group_id`) REFERENCES `member_group` (`group_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
